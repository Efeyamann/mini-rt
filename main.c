...
t_scene init_mock_scene()
{
    ...
    scene.spheres[0].center = (t_vec3){0.0, 0.0, 5.0};
    scene.spheres[0].diameter = 2.0;
    scene.spheres[0].color = (t_vec3){255.0, 0.0, 0.0};
    
	camera.position = (t_vec3){0.0, 0.0, 0.0};
	camera.orientation = (t_vec3){0, 0, 1};
	camera.fov = 90;

	light.position = (t_vec3){-3.0, 6.0, 2.0};
	light.brightness = 0.5;
	light.color = (t_vec3){100.0, 100.0, 100.0};
